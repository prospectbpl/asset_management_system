...
//   const [editClient, setEditClient] = useState(null); // State to store data of client being edited
//   const [deleteClient, setDeleteClient] = useState(null); // State to store data of client being deleted
...
//     setIsDeleteModalOpen(false); // Close delete modal when adding, editing, or closing modal
//   };
...
//   const handleStatusModalOpen = (client) => {
//     setEditClient(client); // Set the selected employee
...
//                       Client List
//                     </h6>
//                     <div onClick={handleAddClient} style={{ padding: "5px 10px", backgroundColor: "#4E73DF", color: "white", borderRadius: "30px", cursor: "pointer" }} onMouseEnter={(e) => e.target.style.backgroundColor = 'red'} onMouseLeave={(e) => e.target.style.backgroundColor = '#4E73DF'}>
//                       Add New Client
//                     </div>
//                   </div>
...
//                                       <span> Details</span>
//                                     </a>
//                                     <a className="dropdown-item" href="#" onClick={() => handleEditClient(client)}><i className="fas fa-edit"></i> Edit</a>
//                                     <a className="dropdown-item" href="#" onClick={() => handleDeleteClient(client)}><i className="fa fa-trash"></i> Delete</a>
//                                   </div>
//                                 </div>
//                                 <div
//                                   className={getToggleClass(client.status)}
//                                   onClick={() => handleStatusModalOpen(client)}
//                                 >
//                                   <div
//                                     className="ball"
//                                     style={{
...
//             </div>
//           )}
//           {isAddClientModalOpen && <AddClientModal onClose={handleCloseClientModal} onUpdateClients={handleUpdateClient} />}
