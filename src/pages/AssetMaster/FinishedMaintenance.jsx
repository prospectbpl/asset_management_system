...
function FinishedMaintenance({ handleLogout, username }) {
  // FinishedMaintenance 
  ...
  const fetchMaintenance = async () => {
    try {
      ...
      const finishedMaintenance = response.data.filter(item => item.task === "finished");
...
export default FinishedMaintenance;
...
//         </div>
//       )}
//       {isAddMaintenanceModalOpen && <AddMaintenanceData onClose={handleCloseMaintenanceModal} />}
//       {isEditModalOpen && (
//         <EditMaintenanceModal
//           maintenanceItem={editMaintenance}
//           onClose={handleCloseMaintenanceModal}
