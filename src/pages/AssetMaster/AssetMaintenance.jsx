    ...
    <div className='d-flex w-100 h-100 '>
      ...
      <div className='w-100'>
        ...
        <div className="container-fluid">
              ...
              <div className="col-xl-12">
                <div className="card shadow mb-4">
                  <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div onClick={handleAddMaintenance} style={{ padding: "5px 10px", backgroundColor: "#4E73DF", color: "white", borderRadius: "30px", cursor: "pointer" }} onMouseEnter={(e) => e.target.style.backgroundColor = 'red'} onMouseLeave={(e) => e.target.style.backgroundColor = '#4E73DF'}>
                      Add Maintenance
                    </div>
          ...
          {isAddMaintenanceModalOpen && <AddMaintenanceData onClose={handleCloseMaintenanceModal} onUpdateMaintenances={onUpdateMaintenances} />}
          {isEditModalOpen && (
