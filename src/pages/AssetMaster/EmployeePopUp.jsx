...
const EmployeePopUp = ({ employeeId, onClose }) => {
    ...
    useEffect(() => {
        ...
        const fetchCheckInOutHistory = async () => {
            try {
                const response = await axios.get(
                    `${process.env.REACT_APP_LOCAL_URL}/api/checkincheckout/history/employee/${employeeId}`
                );
        ...
        const fetchEmployeeDetails = async () => {
            try {
                const response = await axios.get(
                    `${process.env.REACT_APP_LOCAL_URL}/particular_employee/${employeeId}`
                );
                        ...
                        {activeSection === "details" && (
                            <div className="row">
                                <div className="col-md-12 pt-3">
                                    ...
                                    <p>Name : {employeeDetails.ename}</p>
                                    <p>Code : {employeeDetails.ecode}</p>
                                    <p>Location: {employeeDetails.elocation}</p>
                                    <p>Designation: {employeeDetails.edesignation}</p>
