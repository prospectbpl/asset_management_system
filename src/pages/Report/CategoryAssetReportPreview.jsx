...
const CategoryAssetReportPreview = ({ record, onClose }) => {
      ...
      <div className="row p-1">
        <div className="modal-content">
          <div className="modal-header m-0 p-2 d-flex align-items-center justify-content-between px-3">
            ...
            <h4 style={{ color: "#3F4D67" }} className='title-detail text-uppercase fw-bolder font-bold m-0'>All Category Report</h4>
            <div>
...
export default CategoryAssetReportPreview;
